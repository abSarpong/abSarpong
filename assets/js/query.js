const data = [
  {
    id: 1,
    title: "github-portfolio-clone",
    description: "A frontend code challenge for buycoins",
    languages: {
      nodes: [
        {
          name: "CSS",
    ...
    url: "https://github.com/abSarpong/github-portfolio-clone",
    homepageUrl: "https://michael-sarpong-buycoins-code-challenge.netlify.app/",
  },
  {
    id: 2,
    title: "pharmacy-mngmt-sys",
    description:
      "A react app to manage a list of products and their historical prices.",
    languages: {
      nodes: [
        {
          name: "HTML",
    ...
    url: "https://github.com/abSarpong/pharmacy-mngmt-sys",
    homepageUrl: "#",
  },
  {
    id: 3,
    title: "dynamic-card-ui",
    description:
      "An implementation of a card adjusting to different layouts based on the data provided in React. A test by Cogsy for a frontend engineer role.",
    languages: {
      nodes: [
        {
          name: "HTML",
    ...
    url: "https://github.com/abSarpong/dynamic-card-ui",
    homepageUrl: "https://ms-cogsy-frontend-test.netlify.app/",
  },
];
...
data.map((repo) => {
  const { title, description, url, homepageUrl } = repo;
